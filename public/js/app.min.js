                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-6 pt-4 border-t border-slate-50">
                            <div class="border-b border-slate-100/50 pb-2">
                                <p class="text-[10px] font-black text-slate-400 uppercase leading-none mb-1">Total Facturado</p>
                                <p class="text-lg font-bold text-navy-blue">${AppUtils.formatCurrency(totalVentas)}</p>
                            </div>
                            <div class="border-b border-slate-100/50 pb-2">
                                <p class="text-[10px] font-black text-slate-400 uppercase leading-none mb-1">Costo Repuestos</p>
