        ...
        try {
            ...
            if (result.success && result.data.length > 0) {
                ...
                <div class="relative group">
                    <button onclick="window.location.href='${URLROOT}/auth/solicitudes'" class="p-2 bg-amber-500/10 text-amber-500 rounded-lg alert-shake border border-amber-500/20">
