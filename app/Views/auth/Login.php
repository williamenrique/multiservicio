...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div
                class="inline-flex items-center justify-center w-16 h-16 bg-navy-blue rounded-2xl border border-gray-800 mb-4 shadow-lg">
        ...
        <div class="glass-login p-8 rounded-3xl shadow-2xl">
            <h2 class="text-xl font-bold text-white mb-6 text-center uppercase tracking-widest">
                <?php echo s($data['titulo']); ?></h2>

            <!-- Contenedor dinámico de alertas (errores y sesión activa) -->
            <div id="alert-error"
                class="hidden mb-6 p-4 bg-red-500/10 border border-red-500/50 rounded-xl text-red-500 text-sm font-medium flex items-center gap-3">
            ...
            <form id="formLogin" class="space-y-5">
                ...
                <div>
                    <label for="usuario" class="block text-xs font-bold text-gray-400 uppercase mb-2 ml-1">Usuario o
                ...
                <div>
                    <label for="password"
                        class="block text-xs font-bold text-gray-400 uppercase mb-2 ml-1">Contraseña</label>
                    <div class="relative">
                        <i data-lucide="lock"
                            class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500"></i>
        ...
        <p class="text-center text-gray-600 text-xs mt-8">© <?php echo date('Y'); ?> Taller Pro v2.0 - Gestión
            Profesional</p>
    </div>
