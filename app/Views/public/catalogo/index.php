...
<body>
    ...
    function agregarCarrito(productoId) {
        $.ajax({
            url: '<?php echo URLROOT; ?>/catalogo/agregar-carrito',
            method: 'POST',
            data: {
                id: productoId,
                cantidad: 1,
    ...
    function irAlCarrito() {
        $.get('<?php echo URLROOT; ?>/catalogo/contar-carrito', function(res) {
            if (res.total_items > 0) {
                window.location.href = '<?php echo URLROOT; ?>/catalogo/carrito';
            } else {
                Toastify({
